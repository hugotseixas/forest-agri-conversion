...
Deforestation and land use changes can affect hydrological processes in large basins \citep{Arias2018}; reduce the forest resilience to extreme events (e.g., drought) and other sources of perturbation \citep{Boulton2022}; deforestation and farming practices can reduce convective rainfall and increase surface temperature \citep{Maeda2021}; increase carbon emissions \citep{Gatti2021}; cause important impacts on fauna and flora diversity, soil properties and carbon stocks \citep{Nunes2022, Rittl2017}; and even negatively impact public health \citep{Ellwanger2020}.
...
\begin{figure}[ht]
\includegraphics[width=17cm]{figs/change_lenght_routine_scheme} \caption{Representation of the process to calculate the conversion length from forests to agriculture. All values presented are hiphothetical, and serves only as an ilustration of the method.}\label{fig:routine-plot}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=17cm]{figs/tables_scheme} \caption{ Representation of the tables generated by the conversion length calculation. All values presented are hiphothetical, and serves only as an ilustration of the method.}\label{fig:tables-plot}
\end{figure}
...
This table is named as ``mask\_cells''.
...
Since it is possible that one pixels contains more than one conversion from forest to agriculture, we stored the number of the conversion in the column ``c\_cycle'' (1 is the first conversion cycle).
...
If the forest have suffered any conversion, it starts being considered as a secondary forest, as indicated in the column ``forest\_type''.
...
Previous studies estimated a proportion of 23\% \citep{Morton2006}.
...
From 2006 to 2010, we observed a decrease in both variables, a process that was already observed between 2001 and 2010 \citep{Macedo2012}, which points out a decoupling of soybean expansion and deforestation.
