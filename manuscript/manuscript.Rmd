...
Brazil policies since the 1960s were focused on the expansion of the frontier in the Amazon, specially focused in economic income and land security [@Carvalho2002; @Mcdonald2003].
Such development model led to the construction of thousands of kilometers of roads, and the settlement of large scale livestock farms [@Carvalho2002].
This period was marked with high rates of deforestation of mature forests [@Fearnside2005].
At the same time, cattle and soybean productions started to move to the north direction in the Brazilian territory, in which soybeans cultivation areas followed cattle ranches expansion over the Amazon forest [@Simon2005].
...
TODO: Talk about the Avança Brasil plan [@Carvalho2002].
