...
```{r routine-plot, out.width = "17cm", fig.pos = "h", echo = FALSE, fig.cap = "Representation of the process to calculate the conversion length from forests to agriculture. All values presented are hyphothetical, and serve only as an illustration of the method."}
